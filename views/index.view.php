          ...
          <div class="row">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item" data-bs-interval="5000">
                <img src="img\L_Sala.webp" class="carusel" alt="...">
              ...
              <!--
              <div class="carousel-item" data-bs-interval="5000">
                <img data-src="img\autos.webp" class="lazy carusel" alt="...">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item" data-bs-interval="5000">
                <img data-src="img\L_Colchon.webp" class="lazy carusel" alt="...">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item active" data-bs-interval="5000">
                <img data-src="img\L_Alfombra.webp" class="lazy carusel" alt="...">
                <div class="carousel-caption d-none d-md-block">
  ...
  -->
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
             ...
             <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="img\Salas\Sala0.webp" class="d-block w-100" alt="...">
                </div>
    ...
    <div class="row justify-content-md-center">
      ...
      <div class="col-sm-12 col-md-5 text-center">
        <img src="img\R_Alfombra.webp" class="img-fluid rounded" alt="...">
      </div>
    ...
    <div class="row justify-content-md-center">
      ...
      <div class="col-sm-12 col-md-5 card">
        <div id="carouselVestiduras" class="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img\Vestiduras\Ves_1.webp" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="img\Vestiduras\Ves_2.webp" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="img\Vestiduras\Ves_3.webp" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="img\Vestiduras\Ves_4.webp" class="d-block w-100" alt="...">
            </div>
      ...
      <div class="row justify-content-md-center">
        ...
        <div class="col-sm-12 col-md-5  text-center">
          ...
          <figure class="figure">
            <img src="img\Colchones\Colchon_C.webp" class="img-thumbnail" alt="...">
